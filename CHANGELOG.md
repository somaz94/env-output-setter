...
- build\(deps\): bump docker/setup-buildx-action from 3 to 4 [\#11](https://github.com/somaz94/env-output-setter/pull/11) ([dependabot[bot]](https://github.com/apps/dependabot))
- build\(deps\): bump docker/build-push-action from 6 to 7 [\#10](https://github.com/somaz94/env-output-setter/pull/10) ([dependabot[bot]](https://github.com/apps/dependabot))
